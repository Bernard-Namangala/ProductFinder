...
from .forms import EditEmailForm, EditPhoneNumberForm, EditWebsiteForm, EditName
...
@login_required()
def edit_website_view(request):
    """
    edit website view
    """
    if request.method == "GET":
        form = EditWebsiteForm()
        return render(request, 'profile_editing/add_or_edit_website.html', {"form":form})
