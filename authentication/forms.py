...
class EditWebsiteForm(forms.Form):
    """
    edit website url for user form
    """
    website = forms.URLField(max_length=2086, widget=forms.URLInput(attrs={'id': 'website',"placeholder":"Enter your website url"}))
    ...
    def clean_website(self, *args, **kwargs):
        ...
        try:
            ...
            raise ValidationError(f"{website} is not a valid url")
